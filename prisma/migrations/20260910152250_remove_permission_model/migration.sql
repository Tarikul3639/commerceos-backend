...
*/
-- CreateEnum
CREATE TYPE "Permission" AS ENUM ('USER_CREATE', 'USER_READ', 'USER_UPDATE', 'USER_DELETE', 'ROLE_CREATE', 'ROLE_READ', 'ROLE_UPDATE', 'ROLE_DELETE', 'PRODUCT_CREATE', 'PRODUCT_READ', 'PRODUCT_UPDATE', 'PRODUCT_DELETE', 'ORDER_CREATE', 'ORDER_READ', 'ORDER_UPDATE', 'ORDER_DELETE', 'PURCHASE_CREATE', 'PURCHASE_READ', 'PURCHASE_UPDATE', 'PURCHASE_DELETE', 'STOCK_CREATE', 'STOCK_READ', 'STOCK_UPDATE', 'STOCK_DELETE');

...
const envValidationSchema = Joi.object({
    ...
    // ============================
    JWT_USER_ACCESS_SECRET: Joi.string().required(),
    JWT_USER_ACCESS_EXPIRES_IN: Joi.string()
        .pattern(/^\d+(ms|s|m|h|d|w|y)$/)
        .required(),
    JWT_USER_REFRESH_SECRET: Joi.string().required(),
    ...
    // ============================
    JWT_CUSTOMER_ACCESS_SECRET: Joi.string().required(),
    JWT_CUSTOMER_ACCESS_EXPIRES_IN: Joi.string()
        .pattern(/^\d+(ms|s|m|h|d|w|y)$/)
        .required(),
